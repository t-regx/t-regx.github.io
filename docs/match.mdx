...
<CodeTabs
    tregx={`pattern('[0-9]+')->search("I'm 19 years old. I was born in 1999")->first();`}
...
<CodeTabs
    tregx={`pattern('[0-9]+')->search("I'm 19. I was born in 1999, on May 12")->all();`}
...
<CodeTabs
    tregx={`pattern('[0-9]+')->search("I'm 19. I was born in 1999, on May 12")->only(2);`}
    php={`preg::match_all('/[0-9]+/', "I'm 19. I was born in 1999, on May 12", $matches);
