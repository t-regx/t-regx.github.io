...
export function optionalGroupBody(question, code) {
  return <>
...
export default <Question
  body={optionalGroupBody("How is an *optional*, unmatched group `#1` represented in `preg_match()`, when currency is missing?", code)}>
  <Answer code={answerMissing} help={helpMissing}>
    Isn't present in the result
  </Answer>
  <Answer code={answerEmpty} help={helpEmpty} correct>
    As an empty string
  </Answer>
