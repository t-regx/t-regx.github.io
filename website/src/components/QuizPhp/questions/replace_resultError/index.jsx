...
export default <Question
  ...
  <Answer markdown help={help} hoverCode={"preg_replace('/invalid pattern{1,/', $subject, '') === false;"}>
    `$result === false`
  </Answer>
  ...
  <Answer markdown help={help} hoverCode={"preg_replace('/invalid pattern{1,/', $subject, '') === null;"} correct>
    `$result === null`
  </Answer>
</Question>;
