...
export default function Index() {
    ...
    return <Layout>
        ...
        <div className="mainContainer" style={{overflow: 'hidden'}}>
            ...
            <GridBlock columns={sections.replaceDetails}/>
            <GridBlock columns={sections.preparedPatterns} darkBackground scrollableBackground/>
...
const HomeSplash = ({title, tagline}) => (
    <SplashContainer>
        ...
        <PromoSection>
            ...
            <HeaderButton to="docs/introduction-preg">See Docs</HeaderButton>
