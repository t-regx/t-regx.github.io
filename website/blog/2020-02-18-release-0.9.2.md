...
Here's a release on github: https://github.com/T-Regx/T-Regx/releases/tag/v0.9.2 (see [Changelog.md](https://github.com/T-Regx/T-Regx/blob/master/ChangeLog.md)).
